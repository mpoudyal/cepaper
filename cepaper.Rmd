...
mplot1 <- mplot1 + layer(panel.text(5, 59, '3375', col="red")) + 
  layer(panel.text(2.5, 59, '2331', col="red")) + 
  layer(panel.text(0,59, '1366', col="red")) + 
  layer(panel.text(5, 40, '3777', col="red")) + 
  layer(panel.text(2.5, 40, '2732', col="red")) + 
  layer(panel.text(0, 40, '1768', col="red")) + 
  layer(panel.text(0, 21, '3375', col="red")) + 
  layer(panel.text(2.5, 21, '3777', col="red")) +
  layer(panel.text(5, 21, '4018', col="red"))
...
- *npv_oc_all* (=**2375**): Median opportunity costs (NPV) estimated per household (full sample - i.e., CAZ and existing PA sites)

- *npv_oc_caz* (=**1568**): Median opportunity costs (NPV) estimated per household (for CAZ sites)
...
- *cv_com* (=**79**): Average valuation of the compensation provided to the households (estimated from contingent valuation survey with 62 PAP households in *Ampahitra*)

- *elig_hh* (=**5771**): Total number of households estimated in/around CAZ protected area with NPV of opportunity costs higher than USD233 (median annual household income)
